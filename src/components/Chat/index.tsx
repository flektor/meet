...
> = (
  ...
  return (
    <section
      aria-label="chat"
      className="p-2 max-w-xl h-screen overflow-y-auto	overflow-x-hidden "
    >
      <div className="h-2/6">
        ...
        >
          ...
          {channel.messages.map((message, index) => {
            ...
            return (
              <li
                key={index}
                className={`flex m-2 max-w-lg flex-col gap-4 rounded-xl bg-${msg_clr} p-4 text-white ${float}`}
              >
                <i>
