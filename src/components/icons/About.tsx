...
const About: FunctionComponent<AboutProps> = (
  ...
  return (
    <Svg
      innerRef={innerRef}
      className={`hover:cursor-pointer transition duration-500 group fill-white/60 hover:fill-primary ${
        active ? "fill-primary" : "fill-white"
      } ${className}`}
      viewBox={viewBox}
      onClick={onClick}
    >
      <path d="M8.28906 6.29C7.86906 6.29 7.53906 5.95 7.53906 5.54V2.75C7.53906 2.34 7.86906 2 8.28906 2C8.70906 2 9.03906 2.34 9.03906 2.75V5.53C9.03906 5.95 8.70906 6.29 8.28906 6.29Z" />
      <path d="M15.7109 6.29C15.2909 6.29 14.9609 5.95 14.9609 5.54V2.75C14.9609 2.33 15.3009 2 15.7109 2C16.1309 2 16.4609 2.34 16.4609 2.75V5.53C16.4609 5.95 16.1309 6.29 15.7109 6.29Z" />
