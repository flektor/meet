...
const Send: FunctionComponent<SendProps> = (
  { className = "fill-white", viewBox, onClick },
) => {
  return (
    <Svg className={className} viewBox={viewBox} onClick={onClick}>
      <path
        transform="rotate(45) translate(7,-9) scale(0.9)"
        fillRule="evenodd"
        clipRule="evenodd"
